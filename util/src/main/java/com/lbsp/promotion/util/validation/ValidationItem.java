...
public class ValidationItem {
	...
	public ValidationItem(String fieldName, String value, boolean required, String min, String max, ValidationRule rule){
		this.min = min;
		this.fieldName = fieldName;
		this.value = value;
		this.required = required;
	...
	public ValidationItem(String fieldName, String value, boolean required, String max, ValidationRule rule){
		this.fieldName = fieldName;
		this.value = value;
		this.required = required;
		this.rule = rule;
